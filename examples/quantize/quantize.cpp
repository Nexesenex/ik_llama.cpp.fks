...
static const std::vector<struct quant_option> QUANT_OPTIONS = {
    ...
    { "IQ2_K_LR",   LLAMA_FTYPE_MOSTLY_IQ2_K_LR,   " 2.675 bpw non-linear quantization",},
    { "IQ3_K_SR",   LLAMA_FTYPE_MOSTLY_IQ3_K_SR,   " 3.14 bpw non-linear quantization", },
    { "IQ3_K_142L", LLAMA_FTYPE_MOSTLY_IQ3_K_142L, " 3.14 bpw non-linear quantization", },
    { "IQ3_K_143L", LLAMA_FTYPE_MOSTLY_IQ3_K_143L, " 3.24 bpw non-linear quantization", },
    { "IQ3_K_144L", LLAMA_FTYPE_MOSTLY_IQ3_K_144L, " 3.34 bpw non-linear quantization", },
    { "IQ3_K_145L", LLAMA_FTYPE_MOSTLY_IQ3_K_145L, " 3.44 bpw non-linear quantization", },
    { "IQ3_K_LR",   LLAMA_FTYPE_MOSTLY_IQ3_K_LR,   " 3.74 bpw non-linear quantization", },
    { "IQ4_K_SR",   LLAMA_FTYPE_MOSTLY_IQ4_K_SR,   " 4.2 bpw non-linear quantization",  },
    { "IQ4_K_142L", LLAMA_FTYPE_MOSTLY_IQ4_K_142L, " 4.2 bpw non-linear quantization",  },
    { "IQ4_K_143L", LLAMA_FTYPE_MOSTLY_IQ4_K_143L, " 4.3 bpw non-linear quantization",  },
    { "IQ4_K_144L", LLAMA_FTYPE_MOSTLY_IQ4_K_144L, " 4.4 bpw non-linear quantization",  },
    { "IQ4_K_145L", LLAMA_FTYPE_MOSTLY_IQ4_K_145L, " 4.5 bpw non-linear quantization",  },
    { "IQ4_K_LR",   LLAMA_FTYPE_MOSTLY_IQ4_K_LR,   " 4.8 bpw non-linear quantization",  },
    { "IQ5_K_SR",   LLAMA_FTYPE_MOSTLY_IQ5_K_SR,   " 5.2 bpw non-linear quantization",  },
    { "IQ5_K_142L", LLAMA_FTYPE_MOSTLY_IQ5_K_142L, " 5.2 bpw non-linear quantization",  },
    { "IQ5_K_143L", LLAMA_FTYPE_MOSTLY_IQ5_K_143L, " 5.3 bpw non-linear quantization",  },
    { "IQ5_K_144L", LLAMA_FTYPE_MOSTLY_IQ5_K_144L, " 5.4 bpw non-linear quantization",  },
    { "IQ5_K_145L", LLAMA_FTYPE_MOSTLY_IQ5_K_145L, " 5.5 bpw non-linear quantization",  },
    { "IQ5_K_LR",   LLAMA_FTYPE_MOSTLY_IQ5_K_LR,   " 5.8 bpw non-linear quantization",  },
    { "IQ6_K_SR",   LLAMA_FTYPE_MOSTLY_IQ6_K_SR,   " 6.3 bpw non-linear quantization",  },
    { "IQ6_K_142L", LLAMA_FTYPE_MOSTLY_IQ6_K_142L, " 6.3 bpw non-linear quantization",  },
    { "IQ6_K_143L", LLAMA_FTYPE_MOSTLY_IQ6_K_143L, " 6.4 bpw non-linear quantization",  },
    { "IQ6_K_144L", LLAMA_FTYPE_MOSTLY_IQ6_K_144L, " 6.5 bpw non-linear quantization",  },
    { "IQ6_K_145L", LLAMA_FTYPE_MOSTLY_IQ6_K_145L, " 6.6 bpw non-linear quantization",  },
